  ...
  return (
    <>
      ...
      >
        <h2
          style={{
            fontFamily: "PorscheRegular",
          }}
          className="text-2xl font-extrabold text-center pt-10"
        >
          PORSCHE
        </h2>
          ...
          <div className="flex items-center gap-12 mt-10">
            <div className="flex flex-col items-center">
              <div className="flex gap-2 items-center">
                ...
                <p className="font-semibold text-3xl">
                  ₹{scenes[displaySlide].price.toLocaleString("en-IN")}
                </p>
              </div>
              <p className="text-sm opacity-80">Exclusive Taxes</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-2">
                ...
                <p className="font-semibold text-3xl">
                  {scenes[displaySlide].acceleration} sec
                </p>
              </div>
              <p className="text-sm opacity-80">0-100 kmh Acceleration</p>
            </div>
          </div>
        </div>
      </div>
